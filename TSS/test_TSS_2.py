...
class Board:
    def __init__(self, list_list_board, AI, p1_c):
        # Initialise a  board
    ...
    def get_next_move(self, opp_move=None):
        if opp_move:
            assert self.board[opp_move[0], opp_move[1]] == empty, "opp_move not empty!"
            self.board[opp_move[0], opp_move[1]] = self.p1_c
